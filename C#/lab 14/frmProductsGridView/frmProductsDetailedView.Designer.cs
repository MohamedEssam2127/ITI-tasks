namespace frmProductsGridView
{
    partial class frmProductsDetailedView
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtJobId = new TextBox(); // تم التغيير هنا من ComboBox لـ TextBox
            IdValue = new TextBox();
            ...
            btnPrev.TabIndex = 12;
            btnPrev.Text = "<";
            btnPrev.Click += btnPrev_Click; // ربط ميثود الـ Previous
            ...
            btnNext.TabIndex = 11;
            btnNext.Text = ">";
            btnNext.Click += btnNext_Click; // ربط ميثود الـ Next
            ...
            // txtJobId
            txtJobId.Location = new Point(242, 240);
            txtJobId.Name = "txtJobId";
            txtJobId.Size = new Size(158, 27);
            txtJobId.TabIndex = 4;
            ...
            Controls.Add(txtJobId); // إضافة الـ TextBox الجديد
        ...
        private TextBox txtJobId; // تم التغيير هنا
